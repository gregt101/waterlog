/*
 * JS for Page7 generated by Appery.io
 *
...
j_7_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    ...
    // screen onload
    screen_0A4C_onLoad = j_7_onLoad = function() {
        screen_0A4C_elementsExtraJS();

        j_7_deviceEvents();
        j_7_windowEvents();
        screen_0A4C_elementsEvents();
    }

    // screen window events
    screen_0A4C_windowEvents = j_7_windowEvents = function() {
    ...
    screen_0A4C_elementsExtraJS = j_7_elementsExtraJS = function() {
        // screen (screen-0A4C) extra code

    }

    // screen elements handler
    screen_0A4C_elementsEvents = j_7_elementsEvents = function() {
