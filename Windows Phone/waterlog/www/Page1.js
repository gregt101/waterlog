/*
 * JS for Page1 generated by Appery.io
 *
...
j_192_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobilebutton_2': 'j_195'
    };
    ...
    // screen onload
    screen_10B3_onLoad = j_192_onLoad = function() {
        screen_10B3_elementsExtraJS();

        j_192_deviceEvents();
        j_192_windowEvents();
        screen_10B3_elementsEvents();
    }

    // screen window events
    screen_10B3_windowEvents = j_192_windowEvents = function() {
        $('#j_192').bind('pageshow orientationchange', function() {
    ...
    screen_10B3_elementsExtraJS = j_192_elementsExtraJS = function() {
        // screen (screen-10B3) extra code

    }

    // screen elements handler
    screen_10B3_elementsEvents = j_192_elementsEvents = function() {
        ...
        $('#j_194 [name="mobilebutton_2"]').die().live({
            click: function() {
    ...
    $("#j_192").die("pagebeforeshow").live("pagebeforeshow", function(event, ui) {
        j_192_beforeshow();
    });
...
$("#j_192").die("pageinit").live("pageinit", function(event, ui) {
